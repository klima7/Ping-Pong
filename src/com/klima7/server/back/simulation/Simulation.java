...
public class Simulation {
	...
	public synchronized GameData getClientData() {
		...
		return new GameData(server.getPosition(), ballPosition, clientPoints, serverPoints);
	}

	public synchronized GameData getServerData() {
		Point ballPosition = new Point((int)ball.getX(), (int)ball.getY());
		return new GameData(client.getPosition(), ballPosition, serverPoints, clientPoints);
	}
